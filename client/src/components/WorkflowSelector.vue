<template>
    <div class="d-flex justify-content-center border-style">
        <RouterLink class="txt" :to="{ name: 'Workflows', params: { productName: `audio` } }">
...
.border-style {
    border-top: 1.75px solid #1a2456;
    border-bottom: 1.75px solid #1a2456;
}
</style>